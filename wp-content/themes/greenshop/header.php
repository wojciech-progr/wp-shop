                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="navbar__menu" aria-label="main menu">
                            ...
                            <li onclick="showSubElement(this)" class="navbar__option navbar__option--events">
                                ...
                                <ul class="navbar__submenu">
                                    <li class="navbar__submenuOption">Germany <img width="" height=""
                                            class="navbar__submenu--flag" alt="German flag"
                                            src="<?= GREENSHOP_THEME_URL ?>/images/germany-flag.png"></li>
                                    <li class="navbar__submenuOption">Poland <img width="" height=""
                                            class="navbar__submenu--flag" alt="Polish flag"
                                            src="<?= GREENSHOP_THEME_URL ?>/images/poland-flag.png"></li>
                                    <li class="navbar__submenuOption">Austria <img width="" height=""
                                            class="navbar__submenu--flag" alt="Austrian flag"
